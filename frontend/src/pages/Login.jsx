      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[#111622] border-r border-slate-800/80">
        ...
        <div className="my-auto max-w-lg space-y-6">
          ...
          <h1 className="text-4xl font-bold text-white tracking-tight leading-tight">
            Accelerating productivity through simple, clean tools.
          </h1>
          <p className="text-slate-400 text-sm leading-relaxed">
            Welcome back to Note APP. Access your notes dashboard, organize tasks, and sync seamless data.
          </p>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-400">
              Enter your credentials to access Note APP.
            </p>
          </div>
