...
import { User, ArrowLeft, Mail, ShieldCheck, Layers, Copy, Check, Sparkles, Activity, Key, Database, ArrowUpRight } from 'lucide-react'
    ...
    return (
        <div className="relative min-h-screen bg-[#07090E] text-slate-100 selection:bg-cyan-500/20 overflow-hidden font-sans">
            ...
            <main className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-10 lg:py-14">
                ...
                <div className="mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4 border-b border-slate-800/80 pb-8">

                    <div>
                        <button
                            type="button"
                            onClick={() => navigate('/dashboard')}
                            className="inline-flex items-center gap-2 mb-4 mr-2 rounded-xl border border-slate-800 bg-[#0F1420]/80 px-3.5 py-1.5 text-xs font-semibold text-slate-300 hover:text-white hover:border-cyan-500/50 hover:bg-slate-800/80 transition-all cursor-pointer backdrop-blur-md"
                        >
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-cyan-400 backdrop-blur-md mb-3">
                            <Sparkles className="h-3.5 w-3.5 text-cyan-400 animate-pulse inline mr-1" />
                            <span>Profile</span>
                        </div>
